    ...
    function photoClip(container, option) {
        ...
        function resetScroll() {
            ...
            var posX = (clipWidth - imgWidth * myScroll.options.zoomStart) * .5,
                posY = (5/4*clipHeight - imgHeight * myScroll.options.zoomStart) * .5;
        ...
        function initEvent() {
            ...
            $($container).closest(".modal-clip").find(".rotateL").on("click", function () {
                rotateCCW();
            });
            $($container).closest(".modal-clip").find(".rotateR").on("click", function () {
                rotateCW();
            });
        }
        ...
        function rotateBy(angle, point) {
            ...
            var loacl;
            if (!point) {
                loacl = loaclToLoacl($moveLayer, $clipView, clipWidth * .5, 5/4*clipHeight * .5);
            } else {
        ...
        function clipImg() {
            ...
            if (strictSize) {
                ...
                canvas.height = 5/4*clipHeight / scale;
            }
        ...
        function calculateScale(width, height) {
            myScroll.options.zoomMin = getScale(clipWidth, 5/4*clipHeight, width, height);
        ...
        function init() {
            ...
            $clipView = $("<div class='photo-clip-view'>").css({
                ...
                "top": "30%",
                "width": clipWidth,
                "height": 5/4*clipHeight,
                "margin-left": -clipWidth / 2,
                "margin-top": -5/4*clipHeight / 2
            }).appendTo($container);
            ...
            var $mask_top = $("<div class='photo-clip-mask-top'>").css({
                ...
                "top": 0,
                "bottom": "63.6%",
                "margin-bottom": 5/4*clipHeight / 2,
                "background-color": "rgb(144, 202, 190)"
            }).appendTo($mask);
